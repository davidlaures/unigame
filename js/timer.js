...
const startDate = new Date(2017, 12, 8, 00, 00, 00).getTime();// initial date and time the countdown clock started from (Year, Month, Day, Hours, Minutes, Seconds,)
...
function calculateFutureDate (dateTochange){	
		...
		const weeklyDate  = newDate.setDate(newDate.getDate() +01);// adds 7 days to that date
